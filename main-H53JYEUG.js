...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Pi,depthTest:!1,depthWrite:!1})}function SS(){return new Un({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:sh(),fragmentShader:`
		...
		`,blending:Pi,depthTest:!1,depthWrite:!1})}function ES(){return new Un({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:sh(),fragmentShader:`
	...
	`}var rh=class extends kn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let i={width:e,height:e,depth:1},r=[i,i,i,i,i,i];this.texture=new Fc(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let i={uniforms:{tEquirect:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),l=new Ot(a,c),u=new Gc(-1,1,1,-1,0,1),d=null,f=null,h=!1,g,_=null,m=[],p=!1;this.setSize=function(M,w){o.setSize(M,w),s.setSize(M,w);for(let S=0;S<m.length;S++){let T=m[S];T.setSize&&T.setSize(M,w)}},this.setEffects=function(M){m=M,p=m.length>0&&m[0].isRenderPass===!0;let w=o.width,S=o.height;for(let T=0;T<m.length;T++){let C=m[T];C.setSize&&C.setSize(w,S)}},this.begin=function(M,w){if(h||M.toneMapping===fi&&m.length===0)return!1;if(_=w,w!==null){let S=w.width,T=w.height;(o.width!==S||o.height!==T)&&this.setSize(S,T)}return p===!1&&M.setRenderTarget(o),g=M.toneMapping,M.toneMapping=fi,!0},this.hasRenderPass=function(){return p},this.end=function(M,w){M.toneMapping=g,h=!0;let S=o,T=s;for(let C=0;C<m.length;C++){let D=m[C];if(D.enabled!==!1&&(D.render(M,T,S,w),D.needsSwap!==!1)){let y=S;S=T,T=y}}if(d!==M.outputColorSpace||f!==M.toneMapping){d=M.outputColorSpace,f=M.toneMapping,c.defines={},it.getTransfer(d)===ft&&(c.defines.SRGB_TRANSFER="");let C=dP[f];C&&(c.defines[C]=""),c.needsUpdate=!0}c.uniforms.tDiffuse.value=S.texture,M.setRenderTarget(_),M.render(l,u),_=null,h=!1},this.isCompositing=function(){return h},this.dispose=function(){o.dispose(),s.dispose(),a.dispose(),c.dispose()}}var GS=new Li,$v=new Hr(1,1),jS=new Ic,WS=new Gd,$S=new Fc,wS=[],TS=[],CS=new Float32Array(16),IS=new Float32Array(9),AS=new Float32Array(4);function na(n,e,t){let i=n[0];if(i<=0||i>0)return n;let r=e*t,o=wS[r];if(o===void 0&&(o=new Float32Array(r),wS[r]=o),e!==0){i.toArray(o,0);for(let s=1,a=0;s!==e;++s)a+=t,n[s].toArray(o,a)}return o}function zt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function Gt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function ah(n,e){let t=TS[e];t===void 0&&(t=new Int32Array(e),TS[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function hP(n,e){let t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function pP(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(zt(t,e))return;n.uniform2fv(this.addr,e),Gt(t,e)}}function mP(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(zt(t,e))return;n.uniform3fv(this.addr,e),Gt(t,e)}}function gP(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(zt(t,e))return;n.uniform4fv(this.addr,e),Gt(t,e)}}function vP(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(zt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),Gt(t,e)}else{if(zt(t,i))return;AS.set(i),n.uniformMatrix2fv(this.addr,!1,AS),Gt(t,i)}}function yP(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(zt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),Gt(t,e)}else{if(zt(t,i))return;IS.set(i),n.uniformMatrix3fv(this.addr,!1,IS),Gt(t,i)}}function _P(n,e){let t=this.cache,i=e.elements;if(i===void 0){if(zt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),Gt(t,e)}else{if(zt(t,i))return;CS.set(i),n.uniformMatrix4fv(this.addr,!1,CS),Gt(t,i)}}function xP(n,e){let t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function MP(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(zt(t,e))return;n.uniform2iv(this.addr,e),Gt(t,e)}}function bP(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(zt(t,e))return;n.uniform3iv(this.addr,e),Gt(t,e)}}function SP(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(zt(t,e))return;n.uniform4iv(this.addr,e),Gt(t,e)}}function EP(n,e){let t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function wP(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(zt(t,e))return;n.uniform2uiv(this.addr,e),Gt(t,e)}}function TP(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(zt(t,e))return;n.uniform3uiv(this.addr,e),Gt(t,e)}}function CP(n,e){let t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(zt(t,e))return;n.uniform4uiv(this.addr,e),Gt(t,e)}}function IP(n,e,t){let i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r);let o;this.type===n.SAMPLER_2D_SHADOW?($v.compareFunction=t.isReversedDepthBuffer()?eh:Qf,o=$v):o=GS,t.setTexture2D(e||o,r)}function AP(n,e,t){let i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||WS,r)}function DP(n,e,t){let i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||$S,r)}function RP(n,e,t){let i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||jS,r)}function NP(n){switch(n){case 5126:return hP;case 35664:return pP;case 35665:return mP;case 35666:return gP;case 35674:return vP;case 35675:return yP;case 35676:return _P;case 5124:case 35670:return xP;case 35667:case 35671:return MP;case 35668:case 35672:return bP;case 35669:case 35673:return SP;case 5125:return EP;case 36294:return wP;case 36295:return TP;case 36296:return CP;case 35678:case 36198:case 36298:case 36306:case 35682:return IP;case 35679:case 36299:case 36307:return AP;case 35680:case 36300:case 36308:case 36293:return DP;case 36289:case 36303:case 36311:case 36292:return RP}}function PP(n,e){n.uniform1fv(this.addr,e)}function OP(n,e){let t=na(e,this.size,2);n.uniform2fv(this.addr,t)}function LP(n,e){let t=na(e,this.size,3);n.uniform3fv(this.addr,t)}function FP(n,e){let t=na(e,this.size,4);n.uniform4fv(this.addr,t)}function kP(n,e){let t=na(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function UP(n,e){let t=na(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function BP(n,e){let t=na(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function VP(n,e){n.uniform1iv(this.addr,e)}function HP(n,e){n.uniform2iv(this.addr,e)}function zP(n,e){n.uniform3iv(this.addr,e)}function GP(n,e){n.uniform4iv(this.addr,e)}function jP(n,e){n.uniform1uiv(this.addr,e)}function WP(n,e){n.uniform2uiv(this.addr,e)}function $P(n,e){n.uniform3uiv(this.addr,e)}function qP(n,e){n.uniform4uiv(this.addr,e)}function XP(n,e,t){let i=this.cache,r=e.length,o=ah(t,r);zt(i,o)||(n.uniform1iv(this.addr,o),Gt(i,o));let s;this.type===n.SAMPLER_2D_SHADOW?s=$v:s=GS;for(let a=0;a!==r;++a)t.setTexture2D(e[a]||s,o[a])}function YP(n,e,t){let i=this.cache,r=e.length,o=ah(t,r);zt(i,o)||(n.uniform1iv(this.addr,o),Gt(i,o));for(let s=0;s!==r;++s)t.setTexture3D(e[s]||WS,o[s])}function ZP(n,e,t){let i=this.cache,r=e.length,o=ah(t,r);zt(i,o)||(n.uniform1iv(this.addr,o),Gt(i,o));for(let s=0;s!==r;++s)t.setTextureCube(e[s]||$S,o[s])}function JP(n,e,t){let i=this.cache,r=e.length,o=ah(t,r);zt(i,o)||(n.uniform1iv(this.addr,o),Gt(i,o));for(let s=0;s!==r;++s)t.setTexture2DArray(e[s]||jS,o[s])}function KP(n){switch(n){case 5126:return PP;case 35664:return OP;case 35665:return LP;case 35666:return FP;case 35674:return kP;case 35675:return UP;case 35676:return BP;case 5124:case 35670:return VP;case 35667:case 35671:return HP;case 35668:case 35672:return zP;case 35669:case 35673:return GP;case 5125:return jP;case 36294:return WP;case 36295:return $P;case 36296:return qP;case 35678:case 36198:case 36298:case 36306:case 35682:return XP;case 35679:case 36299:case 36307:return YP;case 35680:case 36300:case 36308:case 36293:return ZP;case 36289:case 36303:case 36311:case 36292:return JP}}var qv=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.setValue=NP(t.type)}},Xv=class{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=KP(t.type)}},Yv=class{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){let r=this.seq;for(let o=0,s=r.length;o!==s;++o){let a=r[o];a.setValue(e,t[a.id],i)}}},jv=/(\w+)(\])?(\[|\.)?/g;function DS(n,e){n.seq.push(e),n.map[e.id]=e}function QP(n,e,t){let i=n.name,r=i.length;for(jv.lastIndex=0;;){let o=jv.exec(i),s=jv.lastIndex,a=o[1],c=o[2]==="]",l=o[3];if(c&&(a=a|0),l===void 0||l==="["&&s+2===r){DS(t,l===void 0?new qv(a,n,e):new Xv(a,n,e));break}else{let d=t.map[a];d===void 0&&(d=new Yv(a),DS(t,d)),t=d}}}var ta=class{constructor(e,t){this.seq=[],this.map={};let i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<i;++s){let a=e.getActiveUniform(t,s),c=e.getUniformLocation(t,a.name);QP(a,c,this)}let r=[],o=[];for(let s of this.seq)s.type===e.SAMPLER_2D_SHADOW||s.type===e.SAMPLER_CUBE_SHADOW||s.type===e.SAMPLER_2D_ARRAY_SHADOW?r.push(s):o.push(s);r.length>0&&(this.seq=r.concat(o))}setValue(e,t,i,r){let o=this.map[t];o!==void 0&&o.setValue(e,i,r)}setOptional(e,t,i){let r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let o=0,s=t.length;o!==s;++o){let a=t[o],c=i[a.id];c.needsUpdate!==!1&&a.setValue(e,c.value,r)}}static seqWithValue(e,t){let i=[];for(let r=0,o=e.length;r!==o;++r){let s=e[r];s.id in t&&i.push(s)}return i}};function RS(n,e,t){let i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}var eO=37297,tO=0;function nO(n,e){let t=n.split(`
`),i=[],r=Math.max(e-6,0),o=Math.min(e+6,t.length);for(let s=r;s<o;s++){let a=s+1;i.push(`${a===e?">":" "} ${a}: ${t[s]}`)}return i.join(`
`)}var NS=new Ge;function iO(n){it._getMatrix(NS,it.workingColorSpace,n);let e=`mat3( ${NS.elements.map(t=>t.toFixed(4))} )`;switch(it.getTransfer(n)){case Ec:return[e,"LinearTransferOETF"];case ft:return[e,"sRGBTransferOETF"];default:return De("WebGLProgram: Unsupported color space: ",n),[e,"LinearTransferOETF"]}}function PS(n,e,t){let i=n.getShaderParameter(e,n.COMPILE_STATUS),o=(n.getShaderInfoLog(e)||"").trim();if(i&&o==="")return"";let s=/ERROR: 0:(\d+)/.exec(o);if(s){let a=parseInt(s[1]);return t.toUpperCase()+`
...
`)}var oO={[xv]:"Linear",[Mv]:"Reinhard",[bv]:"Cineon",[Sv]:"ACESFilmic",[wv]:"AgX",[Tv]:"Neutral",[Ev]:"Custom"};function sO(n,e){let t=oO[e];return t===void 0?(De("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}var nh=new O;function aO(){it.getLuminanceCoefficients(nh);let n=nh.x.toFixed(4),e=nh.y.toFixed(4),t=nh.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(tl).join(`
`)),s=Zv(s),s=OS(s,t),s=LS(s,t),a=Zv(a),a=OS(a,t),a=LS(a,t),s=FS(s),a=FS(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+p);let w=M+m+s,S=M+p+a,T=RS(r,r.VERTEX_SHADER,w),C=RS(r,r.FRAGMENT_SHADER,S);r.attachShader(_,T),r.attachShader(_,C),t.index0AttributeName!==void 0?r.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(_,0,"position"),r.linkProgram(_);function D(I){if(n.debug.checkShaderErrors){let L=r.getProgramInfoLog(_)||"",k=r.getShaderInfoLog(T)||"",G=r.getShaderInfoLog(C)||"",B=L.trim(),H=k.trim(),F=G.trim(),Q=!0,Z=!0;if(r.getProgramParameter(_,r.LINK_STATUS)===!1)if(Q=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,_,T,C);else{let ue=PS(r,T,"vertex"),ge=PS(r,C,"fragment");Ae("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(_,r.VALIDATE_STATUS)+`
